...
4. Exporter читает только реальный runtime-снапшот из JSON-файла (`METRICS_SNAPSHOT_PATH`); при отсутствии снапшота `/metrics` не подменяется synthetic данными.
