...
StructuralPlasticity::StructuralPlasticity(const StructuralPlasticityConfig config)
    : config_(config) {
    validate_config();
}

StructuralPlasticityStats StructuralPlasticity::on_tick(
...
StructuralPlasticityStats StructuralPlasticity::run_once(
    const senna::core::domain::Lattice& lattice,
    const std::vector<senna::core::domain::Neuron>& neurons,
    senna::core::domain::SynapseStore& synapses) {
...
void StructuralPlasticity::reset() noexcept {
    ticks_since_update_ = 0U;
    total_pruned_ = 0U;
    total_sprouted_ = 0U;
}
...
std::size_t StructuralPlasticity::prune_weak_synapses(
...
std::size_t StructuralPlasticity::sprout_for_quiet_neurons(
    const senna::core::domain::Lattice& lattice,
    const std::vector<senna::core::domain::Neuron>& neurons,
    senna::core::domain::SynapseStore& synapses) const {
...
void StructuralPlasticity::validate_config() const {
