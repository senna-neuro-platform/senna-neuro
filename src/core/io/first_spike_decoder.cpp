...
FirstSpikeDecoder::FirstSpikeDecoder(std::vector<senna::core::domain::NeuronId> output_neurons,
                                     const senna::core::domain::Weight wta_weight)
...
int FirstSpikeDecoder::decode(
    const std::vector<senna::core::domain::SpikeEvent>& output_spikes) const {
...
std::vector<senna::core::domain::SpikeEvent> FirstSpikeDecoder::winner_take_all_events(
    const senna::core::domain::NeuronId winner_id, const senna::core::domain::Time t_now) const {
